...
type CacheItem = 
    { Value: obj; Added: DateTime; Duration: TimeSpan }
    member __.IsValid() =
...
type Cache private () = 
    ...
    static member private Store = new ConcurrentDictionary<obj, CacheItem>()

    static member private Invalidate(item: obj): unit =
    ...
    static member Add(source: unit -> obj) (duration: TimeSpan) : obj =
